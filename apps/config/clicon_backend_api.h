 ...
 * Add DB dependency
 */
dbdep_handle_t dbdep_w(clicon_handle h, uint16_t row, trans_cb_type, trans_cb, void *, int, ...);
#define dbdep(h, t, cb, arg, nkeys, args...) dbdep_w((h), 0xffff, (t), (cb), (arg), (nkeys), ##args)
 ...
 */
int notify_log(char *stream, char *format, ...);
